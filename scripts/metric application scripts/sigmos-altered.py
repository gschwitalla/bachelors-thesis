# Original script from https://github.com/microsoft/SIG-Challenge
# Modified by Gerrit Schwitalla for use in this thesis.
...
class SigMOS:
    ...
    def run(self, args, sr=None):
        samples = []
        samples = glob.glob(os.path.join(args.testset_dir, "*.wav"))
...
if __name__ == '__main__':
    ...
    dummy_result = sigmos_estimator.run(args, sr=sampling_rate)
    print(dummy_result)
