...
axes[0, 0].set_xlabel('MOS_COL', fontsize=15)
...
axes[0, 1].set_xlabel('MOS_DISC', fontsize=15)
...
axes[0, 2].set_xlabel('MOS_LOUD', fontsize=15)
...
axes[1, 0].set_xlabel('MOS_NOISE', fontsize=15)
...
axes[1, 1].set_xlabel('MOS_REVERB', fontsize=15)
...
axes[1, 2].set_xlabel('MOS_SIG', fontsize=15)
axes[1, 2].set_ylabel('Count', fontsize=15)

# MOS_OVRL
axes[2, 0].hist(df['MOS_OVRL'], bins=50, color='green', alpha=0.7)
axes[2, 0].set_title('Distribution of MOS_OVRL', fontsize=15)
axes[2, 0].set_xlabel('MOS_OVRL', fontsize=15)
axes[2, 0].set_ylabel('Count', fontsize=15)
...
plt.xlabel('MOS_SIG', fontsize=15)
...
plt.xlabel('MOS_NOISE', fontsize=15)
plt.ylabel('Count', fontsize=15)
plt.show()
